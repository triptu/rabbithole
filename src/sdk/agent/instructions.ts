...
export const EVENT_REMINDERS: Record<string, string> = {
  "document.annotate": `Reply { "terms": [...] } — 5–12 exact phrases copied from payload.text that THIS reader probably does not know, given their field and what you know about them. Add "title" if the document has none.`,
...
- document.annotate → { "terms": [exact phrases from payload.text this reader likely does not know], "title"? }. The page highlights the first occurrence of each. 5–12; specific jargon over common words; skip what their field already covers.
